...
(function ($) {
	...
	$(function () {
		...
		$(".opt-1r").css("display", "none");
		$(".opt-2r").css("display", "none");
		$(".opt-3r").css("display", "none");
		$(".opt-4r").css("display", "none");
		$(".opt-5r").css("display", "none");

		$("#sw-1").on("click", function () {
			if ($(this).is(":checked")) {
				$(".opt-1l").css("display", "none");
				$(".opt-1r").css("display", "inline-block");
			} else {
				$(".opt-1r").css("display", "none");
				$(".opt-1l").css("display", "inline-block");
			}
		});

		$("#sw-2").on("click", function () {
			if ($(this).is(":checked")) {
				$(".opt-2l").css("display", "none");
				$(".opt-2r").css("display", "inline-block");
			} else {
				$(".opt-2r").css("display", "none");
				$(".opt-2l").css("display", "inline-block");
			}
		});

		$("#sw-3").on("click", function () {
			if ($(this).is(":checked")) {
				$(".opt-3l").css("display", "none");
				$(".opt-3r").css("display", "inline-block");
			} else {
				$(".opt-3r").css("display", "none");
				$(".opt-3l").css("display", "inline-block");
			}
		});

		$("#sw-4").on("click", function () {
			if ($(this).is(":checked")) {
				$(".opt-4l").css("display", "none");
				$(".opt-4r").css("display", "inline-block");
			} else {
				$(".opt-4r").css("display", "none");
				$(".opt-4l").css("display", "inline-block");
			}
		});

		$("#sw-5").on("click", function () {
			if ($(this).is(":checked")) {
				$(".opt-5l").css("display", "none");
				$(".opt-5r").css("display", "inline-block");
			} else {
				$(".opt-5r").css("display", "none");
				$(".opt-5l").css("display", "inline-block");
			}
		});
